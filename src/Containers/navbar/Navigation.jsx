      ...
      <AppBar position="static" sx={{ padding: 0 }}>
        ...
        >
          ...
          <Box sx={{ display: { xs: "none", md: "flex" } }}>
            ...
            >
              <MenuItem onClick={handleClose}>Avinash Kumar</MenuItem>
              <MenuItem onClick={handleClose}>Prabhat Kumar</MenuItem>
              <MenuItem onClick={handleClose}>Deepak Singh Patel</MenuItem>
              <MenuItem onClick={handleClose}>Shekhar Kumar Suman</MenuItem>
            </Menu>
          </Box>
